...
async function editMeal(req: NextApiRequest, res: NextApiResponse) {
  const body = req.body;
          ...
          connectOrCreate: Object.entries(foodBody).map(([key, value]) => {
            ...
            return {
              ...
              create: {
                name: value.name,
                calcium: parseFloat(
                  parseFloat(value.calcium * multiplier).toFixed(2)
                ),
                calories: parseFloat(
                  parseFloat(value.calories * multiplier).toFixed(2)
                ),
                cholesterol: parseFloat(
                  parseFloat(value.cholesterol * multiplier).toFixed(2)
                ),
                fiber: parseFloat(
                  parseFloat(value.fiber * multiplier).toFixed(2)
                ),
                iron: parseFloat(
                  parseFloat(value.iron * multiplier).toFixed(2)
                ),
                potassium: parseFloat(
                  parseFloat(value.potassium * multiplier).toFixed(2)
                ),
                protein: parseFloat(
                  parseFloat(value.protein * multiplier).toFixed(2)
                ),
                quantity: parseFloat(parseFloat(multiplier).toFixed(2)),
                sodium: parseFloat(
                  parseFloat(value.sodium * multiplier).toFixed(2)
                ),
                sugar: parseFloat(
                  parseFloat(value.sugar * multiplier).toFixed(2)
                ),
                total_carbohydrates: parseFloat(
                  parseFloat(value.total_carbohydrates * multiplier).toFixed(2)
                ),
                total_fat: parseFloat(
                  parseFloat(value.total_fat * multiplier).toFixed(2)
                ),
                type: value.type,
              },
            };
